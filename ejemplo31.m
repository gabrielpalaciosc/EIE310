...
r1 = 3; r2 = 40; r3 = 3; r4 = 40; r5 = 3;
% Desviaciones en las bandas
d1 = (10^(r1/20)-1)/(10^(r1/20)+1);
d2 = 10^(-r2/20);
d3 = (10^(r3/20)-1)/(10^(r3/20)+1);
d4 = 10^(-r4/20);
d5 = (10^(r5/20)-1)/(10^(r5/20)+1);
...
subplot 212; plot(f, 20*log10(abs(H))); xlabel('Hz'); ylabel('dB'); grid